...
StreamrBinaryMessageWithKafkaMetadata.prototype.toArray = function() {
	...
	var m = this.getStreamrBinaryMessage(true)
	return [m.version, m.streamId, m.streamPartition, m.timestamp, m.ttl, this.offset, this.previousOffset, m.contentType, m.content.toString('utf8')]
}
