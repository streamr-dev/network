...
StreamrBinaryMessage.prototype.getContentBuffer = function() {
	return this.content
}

StreamrBinaryMessage.prototype.getContentParsed = function() {
...
/*static*/ StreamrBinaryMessage.fromBytes = function(buf) {
	...
	if (version===28) {
		...
		var content = reader.nextBuffer(contentLength)
