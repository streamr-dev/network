...
StreamrBinaryMessage.prototype.toBufferMaker = function(bufferMaker) {
	...
	var contentBuf = new BufferMaker().string(JSON.stringify(this.content)).make()
	...
	// byte 0: version (1 byte)
		...
		.string(JSON.stringify(this.content))
}

/*static*/ StreamrBinaryMessage.fromBytes = function(buf, skipContent) {
