...
var CassandraHelper = require('./cassandra-helper')
var Stream = require('./stream')
var Connection = require('./connection')

function SocketIoServer(redisHosts, cassandraHosts, cassandraKeyspace, socketio_port, redis, cassandra, io) {
	var _this = this

	this.redis = redis || new RedisHelper(redisHosts)
	this.cassandra = cassandra || new CassandraHelper(cassandraHosts, cassandraKeyspace)

	// This handler is for realtime messages, not resends
	this.redis.on('message', function(message, streamId) {
