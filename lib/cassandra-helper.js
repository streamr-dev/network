...
CassandraHelper.prototype.query = function(query, queryParams, lastKnownOffset, msgHandler, onDone) {
	...
	const done = lastKnownOffset == null ? onDone : function (lastOffset) {
		...
		if (lastKnownOffset <= lastOffset) {
			...
			const f = _this.getOffsetRange.bind(_this, streamId, partition, lastOffset, lastKnownOffset, msgHandler,
