...
module.exports = {
    ...
    async createStream(props, apiKey = this.options.apiKey) {
        if (!props || !props.name) {
    ...
    async getOrCreateStream(props, apiKey = this.options.apiKey) {
        let json
