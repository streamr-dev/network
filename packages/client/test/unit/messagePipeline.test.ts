...
import { collect, toEthereumAddress, hexToBinary, ethereumAddressToByteArray } from '@streamr/utils'
    ...
    const createMessage = async (opts: {
        ...
        return createSignedMessage({
            messageId: new MessageID(
                ...
                Date.now(),
                0,
                ethereumAddressToByteArray(toEthereumAddress(publisher.address)),
                'mock-msgChainId'
            ),
