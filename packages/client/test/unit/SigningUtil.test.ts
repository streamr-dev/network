...
import { toEthereumAddress, binaryToHex, hexToBinary, areEqualBinaries, ethereumAddressToByteArray } from '@streamr/utils'
...
describe(sign, () => {
    it('produces correct signature', async () => {
        ...
        assert.strictEqual(binaryToHex(signature, true), '0x787cd72924153c88350e808de68b68c88030cbc34d053a5c696a5893d5e6fec1687c1b6205ec99aeb3375a81bf5cb8857ae39c1b55a41b32ed6399ae8da456a61b')
    })
})

describe(recover, () => {
    it('recovers correct address', async () => {
        const address = ethereumAddressToByteArray(toEthereumAddress('0x752C8dCAC0788759aCB1B4BB7A9103596BEe3e6c'))
        ...
        const recoveredAddress = recover(hexToBinary(signature), payload)
        expect(areEqualBinaries(recoveredAddress, address)).toEqual(true)
    })
    ...
    it('throws if the address can not be recovered (invalid signature)', async () => {
        ...
        expect(() => recover(hexToBinary(signature), payload)).toThrowError()
    })
    ...
    it('returns a different address if the content is tampered', async () => {
        ...
        const signature = '0xc97f1fbb4f506a53ecb838db59017f687892494a9073315f8a187846865bf8325333315b116f1142921a97e49e3881eced2b176c69f9d60666b98b7641ad11e01b'
        const recoveredAddress = recover(hexToBinary(signature), payload)
        expect(areEqualBinaries(recoveredAddress, address)).toEqual(false)
    })
})
...
describe(verify, () => {
    it('returns true on valid signature', async () => {
        ...
        const payload = 'ogzCJrTdQGuKQO7nkLd3Rw0156700333876720x752c8dcac0788759acb1b4bb7a9103596bee3e6ckxYyLiSUQO0SRvMx6gA115670033387671{"numero":86}'
        const signature = '0xc97f1fbb4f506a53ecb838db59017f687892494a9073315f8a187846865bf8325333315b116f1142921a97e49e3881eced2b176c69f9d60666b98b7641ad11e01b'
        const isValid = verify(address, payload, hexToBinary(signature))
        assert(isValid)
    })
