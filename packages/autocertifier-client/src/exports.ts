export { AutoCertifierClient, AUTOCERTIFIER_SERVICE_ID, GetSessionId } from './AutoCertifierClient'
...
export { SessionIdRequest, SessionIdResponse } from './proto/packages/autocertifier-client/protos/AutoCertifier'
