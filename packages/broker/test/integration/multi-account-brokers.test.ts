...
const networkPort4 = 12364
const trackerPort = 12370

describe('broker: multiple instances with the same identity', () => {
    let tracker: Tracker
    let storageNode: Todo
    let brokerNode1: Todo
    let brokerNode2: Todo
    let brokerNode3: Todo
    ...
    beforeAll(async () => {
        ...
        const commonIdentity = Wallet.createRandom()
        brokerNode1 = await startBroker({
            name: 'brokerNode1',
            privateKey: commonIdentity.privateKey,
        ...
        brokerNode3 = await startBroker({
            name: 'brokerNode3',
            privateKey: commonIdentity.privateKey,
            networkPort: networkPort4,
            trackerPort,
            wsPort: wsPort4,
            streamrAddress: engineAndEditorAccount.address,
            enableCassandra: false,
