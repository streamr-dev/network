...
export type ExtendedOperatorServiceConfig = OperatorServiceConfig & {
...
export class ContractFacade {
    ...
    private readonly config: ExtendedOperatorServiceConfig

    // for tests
    constructor(operatorContract: Operator, theGraphClient: TheGraphClient, config: ExtendedOperatorServiceConfig) {
        this.operatorContract = operatorContract
        this.theGraphClient = theGraphClient
        this.config = config
    }

    static createInstance(config: ExtendedOperatorServiceConfig): ContractFacade {
