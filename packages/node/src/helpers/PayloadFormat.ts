...
export class MetadataPayloadFormat implements PayloadFormat {
    ...
    createMessage(payload: string): Message | never {
        ...
        if (json.metadata !== undefined) {
            ...
            metadata = { 
                ...json.metadata,
                publisherId: (json.metadata.publisherId !== undefined) ? hexToBinary(json.metadata.publisherId) : undefined
            }
        } else {
            metadata = {}
        }
    ...
    createPayload(content: Record<string, unknown>, metadata?: Metadata): string | never {
        ...
        if (metadata !== undefined) {
            ...
            payload.metadata = { 
                ...metadata,
                publisherId: (metadata.publisherId !== undefined) ? binaryToHex(metadata.publisherId, true) : undefined
            }
        }
