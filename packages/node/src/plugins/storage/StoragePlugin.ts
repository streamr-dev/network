...
import { EthereumAddress, Logger, MetricsContext, executeSafePromise, toEthereumAddress, toUserId } from '@streamr/utils'
...
export class StoragePlugin extends Plugin<StoragePluginConfig> {
    ...
    async start(streamrClient: StreamrClient): Promise<void> {
        ...
        const clusterId = this.pluginConfig.cluster.clusterAddress ?? toEthereumAddress(toUserId(await this.streamrClient.getUserId()))
