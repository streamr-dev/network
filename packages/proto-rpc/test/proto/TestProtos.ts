// @generated by protobuf-ts 2.11.1 with parameter server_generic,generate_dependencies
...
/**
 * @generated from protobuf message OptionalRequest
 */
export interface OptionalRequest {
    /**
     * @generated from protobuf field: optional string someOptionalField = 1
     */
    someOptionalField?: string;
}
/**
 * @generated from protobuf message OptionalResponse
 */
...
// @generated message type with reflection information, may provide speed optimized methods
class OptionalRequest$Type extends MessageType<OptionalRequest> {
    constructor() {
        super("OptionalRequest", [
            { no: 1, name: "someOptionalField", kind: "scalar", opt: true, T: 9 /*ScalarType.STRING*/ }
        ]);
    }
}
/**
 * @generated MessageType for protobuf message OptionalRequest
 */
export const OptionalRequest = new OptionalRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class OptionalResponse$Type extends MessageType<OptionalResponse> {
    constructor() {
        super("OptionalResponse", [
            { no: 1, name: "someOptionalField", kind: "scalar", opt: true, T: 9 /*ScalarType.STRING*/ }
        ]);
    }
}
/**
 * @generated MessageType for protobuf message OptionalResponse
 */
export const OptionalResponse = new OptionalResponse$Type();
/**
...
/**
 * @generated ServiceType for protobuf service OptionalService
 */
export const OptionalService = new ServiceType("OptionalService", [
    { name: "getOptional", options: {}, I: OptionalRequest, O: OptionalResponse }
]);
