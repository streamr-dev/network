...
// tslint:disable
import { GracefulDisconnectResponse } from "./DhtRpc";
...
export interface IConnectionLocker<T = ServerCallContext> {
     ...
     */
    gracefulDisconnect(request: DisconnectNotice, context: T): Promise<GracefulDisconnectResponse>;
    /**
     * @generated from protobuf rpc: notifyDisconnect(dht.DisconnectNotice) returns (dht.PingResponse);
     */
    notifyDisconnect(request: DisconnectNotice, context: T): Promise<PingResponse>;
}
