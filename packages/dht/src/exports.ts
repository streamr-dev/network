...
export {
    ConnectionManager, type ConnectionInfoReport, type ConnectionLocker, type PortRange, type TlsCertificate
...
export type { ConnectionInfo } from './connection/ConnectionDiagnostics'
