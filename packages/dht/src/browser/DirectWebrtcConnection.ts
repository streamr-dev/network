...
const logger = new Logger('DirectWebrtcConnection (browser)')

export class DirectWebrtcConnection extends EventEmitter<WebrtcConnectionEvents> implements IWebrtcConnection, IConnection {
