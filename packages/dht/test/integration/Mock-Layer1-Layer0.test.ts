...
describe('Layer 1 on Layer 0 with mocked connections', () => {
    ...
    it('Happy Path', async () => {
        ...
        logger.info('layer1EntryPoint.getPeerCount() ' + layer1EntryPoint.getPeerCount())
        logger.info('layer1Node1.getPeerCount()' + layer1Node1.getPeerCount())
        logger.info('layer1Node2.getPeerCount()' + layer1Node2.getPeerCount())
        logger.info('layer1Node3.getPeerCount()' + layer1Node3.getPeerCount())
        logger.info('layer1Node4.getPeerCount()' + layer1Node4.getPeerCount())

        expect(layer1Node1.getPeerCount()).toEqual(layer0Node1.getPeerCount())
        expect(layer1Node2.getPeerCount()).toEqual(layer0Node2.getPeerCount())
        expect(layer1Node3.getPeerCount()).toEqual(layer0Node3.getPeerCount())
        expect(layer1Node4.getPeerCount()).toEqual(layer0Node4.getPeerCount())

        expect(layer1Node1.getPeers()).toContainValues(layer0Node1.getPeers())
        expect(layer1Node2.getPeers()).toContainValues(layer0Node2.getPeers())
        expect(layer1Node3.getPeers()).toContainValues(layer0Node3.getPeers())
        expect(layer1Node4.getPeers()).toContainValues(layer0Node4.getPeers())
