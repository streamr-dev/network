...
describe('WebSocket IConnection Requests', () => {
    ...
    beforeEach(async () => {
        ...
        node1 = new DhtNode({ peerId: '2', nodeName: 'node1', websocketPortRange: { min: 10022, max: 10022 }, entryPoints: [epPeerDescriptor] })
        node2 = new DhtNode({ peerId: '1', nodeName: 'node2', entryPoints: [epPeerDescriptor] })
        await node1.start()
        await node2.start()
    })
