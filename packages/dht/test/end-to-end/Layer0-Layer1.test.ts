...
describe('Layer0-Layer1', () => {
    ...
    it('Happy path', async () => {
        ...
        expect(stream1Node1.getNeighborList().getContactIds()[0].equals(PeerID.fromValue(node1.getPeerDescriptor().kademliaId))).toEqual(true)
        expect(stream1Node2.getNeighborList().getContactIds()[0].equals(PeerID.fromValue(epPeerDescriptor.kademliaId))).toEqual(true)
        expect(stream2Node1.getNeighborList().getContactIds()[0].equals(PeerID.fromValue(node2.getPeerDescriptor().kademliaId))).toEqual(true)
        expect(stream2Node2.getNeighborList().getContactIds()[0].equals(PeerID.fromValue(epPeerDescriptor.kademliaId))).toEqual(true)
    })
})
