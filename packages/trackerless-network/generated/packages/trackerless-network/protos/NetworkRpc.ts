...
/**
 * Used to build the Any message as it is unsed otherwise
 *
 * @generated from protobuf message AnyImport
 */
...
// @generated message type with reflection information, may provide speed optimized methods
class AnyImport$Type extends MessageType<AnyImport> {
    constructor() {
        super("AnyImport", [
...
/**
 * @generated MessageType for protobuf message AnyImport
 */
export const AnyImport = new AnyImport$Type();
/**
