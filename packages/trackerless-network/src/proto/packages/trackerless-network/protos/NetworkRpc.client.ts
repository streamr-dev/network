...
// tslint:disable
import { InspectionRpc } from "./NetworkRpc";
 ...
 */
export interface IInspectionRpcClient {
    /**
     * @generated from protobuf rpc: openInspectConnection(InspectConnectionRequest) returns (InspectConnectionResponse);
     */
    openInspectConnection(input: InspectConnectionRequest, options?: RpcOptions): UnaryCall<InspectConnectionRequest, InspectConnectionResponse>;
}
/**
 * @generated from protobuf service InspectionRpc
 */
export class InspectionRpcClient implements IInspectionRpcClient, ServiceInfo {
    typeName = InspectionRpc.typeName;
    methods = InspectionRpc.methods;
    options = InspectionRpc.options;
    constructor(private readonly _transport: RpcTransport) {
    }
    /**
     * @generated from protobuf rpc: openInspectConnection(InspectConnectionRequest) returns (InspectConnectionResponse);
