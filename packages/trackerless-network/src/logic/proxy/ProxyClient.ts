...
import { Logger, StreamPartID, UserIDOld, addManagedEventListener, wait } from '@streamr/utils'
...
export class ProxyClient extends EventEmitter<Events> {
    ...
    private async attemptConnection(nodeId: DhtAddress, direction: ProxyDirection, userId: UserIDOld): Promise<void> {
