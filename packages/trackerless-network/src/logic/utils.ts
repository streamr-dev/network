...
export const markAndCheckDuplicate = (duplicateDetectors: Map<string, DuplicateMessageDetector>, currentMessageRef: MessageRef, previousMessageRef?: MessageRef): boolean => {
