...
describe('Plum Tree optimised network with WebSocket connections only', () => {
    ...
    beforeEach(async () => {
        ...
        entryPoint.getContentDeliveryManager().joinStreamPart(streamPartId, { plumTreeOptimisation: true})
