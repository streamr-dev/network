...
describe('random graph with real connections', () => {
    ...
    beforeEach(async () => {
        ...
        dhtNode1 = new DhtNode({ peerId: '1', websocketPortRange, entryPoints: [epPeerDescriptor] })
        dhtNode2 = new DhtNode({ peerId: '2', websocketPortRange, entryPoints: [epPeerDescriptor] })
        dhtNode3 = new DhtNode({ peerId: '3', websocketPortRange, entryPoints: [epPeerDescriptor] })
        dhtNode4 = new DhtNode({ peerId: '4', websocketPortRange, entryPoints: [epPeerDescriptor] })
