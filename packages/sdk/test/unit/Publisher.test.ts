...
describe('Publisher', () => {
    it('error message', async () => {
        ...
        await expect(async () => {
            ...
            message: `Failed to publish to stream ${streamId}. Cause: You don't have permission to publish to this stream. Using address: ${await authentication.getUserIdAsEthereumAddress()}`
        })
    })
})
