import { BrandedString, EthereumAddress, ECDSA_SECP256K1_EVM, MapWithTtl, toUserId, UserID } from '@streamr/utils'
...
export class ERC1271ContractFacade {
    ...
    async isValidSignature(contractAddress: EthereumAddress, payload: Uint8Array, signature: Uint8Array): Promise<boolean> {
        ...
        if (cachedValue !== undefined) {
            ...
            const result = await contract.isValidSignature(ECDSA_SECP256K1_EVM.keccakHash(payload), signature)
