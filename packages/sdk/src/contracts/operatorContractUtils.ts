...
export const delegate = async (delegator: Signer, operatorContractAddress: string, amount: number, token?: TestTokenContract): Promise<void> => {
...
export const undelegate = async (delegator: Signer, operatorContract: OperatorContract, amount: number): Promise<void> => {
...
export const sponsor = async (sponsorer: Signer, sponsorshipContractAddress: string, amount: number, token?: TestTokenContract): Promise<void> => {
...
export const transferTokens = async (from: Signer, to: string, amount: number, data?: string, token?: TestTokenContract): Promise<void> => {
