...
const validateStreamId = (req, res) => {
    ...
    return (0, protocol_1.toStreamID)(streamId);
};
...
const cachedJsonGet = (app, endpoint, maxAge, jsonFactory) => {
    let cache;
    return app.get(endpoint, (_req, res) => {
...
function trackerHttpEndpoints(httpServer, tracker) {
    const app = (0, express_1.default)();
    app.use((0, cors_1.default)());
    app.use((0, compression_1.default)());
    app.use((0, morgan_1.default)(process.env.CUSTOM_MORGAN_FORMAT ?? ':method :url :status :response-time ms - :res[content-length] - :remote-addr'));
    ...
    app.get('/topology-size/', async (_req, res) => {
