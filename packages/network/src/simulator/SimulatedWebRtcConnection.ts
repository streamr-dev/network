...
const SimulatedWebRtcConnectionFactory: WebRtcConnectionFactory = Object.freeze({
    createConnection(opts: ConstructorOptions): WebRtcConnection {
        return new SimulatedWebRtcConnection(opts)
    },
    cleanUp(): void {
...
export default SimulatedWebRtcConnectionFactory

export class SimulatedWebRtcConnection extends WebRtcConnection {
    ...
    protected doConnect(): void {
        ...
        // emit local candidate immediately
