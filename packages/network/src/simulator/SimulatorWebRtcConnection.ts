...
const SimulatorWebRtcConnectionFactory: WebRtcConnectionFactory = Object.freeze({
    createConnection(opts: ConstructorOptions): WebRtcConnection {
        return new SimulatorWebRtcConnection(opts)
    },
    cleanUp(): void {
...
export default SimulatorWebRtcConnectionFactory

export class SimulatorWebRtcConnection extends WebRtcConnection {
