import { getNodeConnections } from '../../../network-tracker/src/logic/trackerSummaryUtils'
...
test('getNodeConnections', () => {
    ...
    const result = getNodeConnections(nodes, overlayPerStreamPart)
