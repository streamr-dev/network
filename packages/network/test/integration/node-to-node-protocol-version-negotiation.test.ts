...
describe('Node-to-Node protocol version negotiation', () => {
    ...
    beforeEach(async () => {
        ...
        const wsEp1 = await startServerWsEndpoint('127.0.0.1', 28555, peerInfo1, null, new MetricsContext(peerInfo1.peerId))
        const wsEp2 = await startServerWsEndpoint('127.0.0.1', 28556, peerInfo2, null, new MetricsContext(peerInfo2.peerId))
        const wsEp3 = await startServerWsEndpoint('127.0.0.1', 28557, peerInfo3, null, new MetricsContext(peerInfo2.peerId))
