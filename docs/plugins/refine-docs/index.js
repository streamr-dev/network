...
module.exports = function(context, options) {
    ...
    const refineAPIRef = async () => {
        ...
        newContent = newContent.replace(
            ...
            "@site/src/components/FeaturedLinks";\n\n### Streamr SDK version \n\n  [![](https://img.shields.io/npm/v/streamr-client?label=latest)](https://www.npmjs.com/package/streamr-client "Streamr sdk") [![GitHub stars](https://img.shields.io/github/stars/streamr-dev/network-monorepo?style=social)](https://github.com/streamr-dev/network/tree/main/packages/client) \n\n Autogenerated from Streamr JS client typescript types \n\n## Featured Classes \n\n<FeaturedLinks links={${JSON.stringify(
