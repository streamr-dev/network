...
Use node version: `v100.0.0-testnet-three.2`. Do not use the `latest` tag release.
...
This `v100.0.0-testnet-three.2` version can be used to connect to Testnet 1 **or** the Mumbai network. 
