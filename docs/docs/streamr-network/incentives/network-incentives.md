...
<!-- Should a non-linear bonding curve be introduced later, the interpretation should remain the same: the value of the delegation tokens is the amount of DATA tokens the delegator would receive after undelegating them. -->
