...
- **BREAKING CHANGE**: The string values in `Message.signatureType` now correspond with the `KeyPairType` values. This means the previously output value `SECP256K1` is now `ECDSA_SECP256K1_EVM`.
