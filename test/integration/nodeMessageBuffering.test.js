...
describe('message buffering of Node', () => {
    ...
    beforeAll(async () => {
        ...
        await Promise.all([
            waitForEvent(sourceNode.protocols.nodeToNode, NodeToNode.events.NODE_CONNECTED),
            waitForEvent(destinationNode.protocols.nodeToNode, NodeToNode.events.NODE_CONNECTED)
        ])
    })
